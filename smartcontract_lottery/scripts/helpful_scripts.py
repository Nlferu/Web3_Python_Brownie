...
# "DECIMALS" is constant variable while "decimals" will be simply just variable (constant variables values cannot be changed) 
# that is why it's highlighting is different (just point ur mouse on each variable to show, if it's constant or not)
DECIMALS = 8
...
def fund_with_link(contract_address, account = None, link_token = None, link_amount = 10 ** 17):
    ...
    link_token = config["networks"]["rinkeby"]["link_token"] or link_token = config["networks"][network.show_active()]["link_token"]
