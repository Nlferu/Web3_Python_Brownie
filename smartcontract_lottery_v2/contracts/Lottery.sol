...
contract Lottery is VRFConsumerBaseV2, Ownable {
    ...
    constructor(address _priceFeedAddress, address _vrfCoordinator, address _link, uint256 _fee, bytes32 _keyHash) public VRFConsumerBaseV2(_vrfCoordinator, _link) {
    ...
    function endLottery() public onlyOwner {
        ...
        bytes32 requestId = requestRandomness(keyHash, fee); // -> this will be requestRandomWords from VRFCoordinatorV2Mock
